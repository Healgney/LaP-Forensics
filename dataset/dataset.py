...
from dataset.gcg_datasets.GranDf_gcg_ds import GranDfDataset, OpenPsgGCGDataset, Flickr30kGCGDataset, RefCOCOgGCGDataset, LaPGCGDataset
...
class HybridDatasetBase(torch.utils.data.Dataset):
    ...
    def __init__(self, dataset_dir, tokenizer, global_image_encoder, dataset, datasets_config,
                 ...
                 num_classes_per_sample=3, sample_rate=None, use_dual_stream=False):
        ...
        self.use_dual_stream = use_dual_stream  # Store dual-stream flag
                ...
                if ds == 'Semantic_Segm':
                    ...
                    datasets.append(
                        dataset_cls(
                            ...
                            validation=False, use_dual_stream=self.use_dual_stream)
                        )
                else:
                    datasets.append(
                        dataset_cls(
...
class HybridSegDataset(HybridDatasetBase):
    def __init__(self, dataset_dir, tokenizer, global_image_encoder, epoch_samples=500 * 8 * 2 * 10, batch_size=2,
                 ...
                 use_dual_stream=False):  # Added use_dual_stream parameter
        ...
        super().__init__(
            dataset_dir, tokenizer, global_image_encoder, dataset, datasets_config, epoch_samples, batch_size,
            precision, image_size, num_classes_per_sample, sample_rate, use_dual_stream=use_dual_stream
        )
