...
def parse_args():
    parser = argparse.ArgumentParser(description="LaP-Forensic detection evaluation")
    ...
    parser.add_argument("--save_path", default="./checkpoints/lap_cls_train", type=str)
    return parser.parse_args()

class LaPClsEvalDataset(Dataset):
...
def main():
    ...
    cls_test_dataset = LaPClsEvalDataset(args, train=False)
