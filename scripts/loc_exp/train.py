...
def parse_args(args):
    parser = argparse.ArgumentParser(description="LaP-Forensic localization and explanation training")
    ...
    parser.add_argument("--zero_stage", default=3, type=int, help="DeepSpeed ZeRO stage (0, 1, 2, 3)")
...
def initialize_deepspeed(model, tokenizer, args):
    # ZeRO configuration
    # Defaulting to user provided stage
    ...
    if args.zero_stage > 0:
        ds_config["zero_optimization"] = zero_optimization_config
